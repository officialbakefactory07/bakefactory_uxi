    ...
    <div className={styles.page}>
      <div className={styles.authCard}>
        ...
        <div className={styles.cardHeader}>
          ...
          <h1>{isLogin ? 'Welcome to Bake Factory' : 'Create an Account'}</h1>
          <p>{isLogin ? 'Sign in to order your favorite artisan cakes & desserts' : 'Join Bake Factory for fast checkout & exclusive offers'}</p>
        </div>
